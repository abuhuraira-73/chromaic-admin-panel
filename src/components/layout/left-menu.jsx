        ...
        <div className="box-logo">
          <Link to="/" id="site-logo-inner">
            <img
              ...
              id="logo_header"
              alt=""
              src="/assets/images/chromaic-logo-2.png"
            ...
            <div className="center-item">
              <ul className="">
                ...
                <li className="menu-item has-children">
                  <a href="#" onClick={(e) => e.preventDefault()} className="menu-item-button">
                    <div className="icon">
                ...
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    <li className="sub-menu-item">
                      <Link to="/attribute" className="">
                        <div className="text">Attributes</div>
                      </Link>
                    </li>
                    <li className="sub-menu-item">
                      <Link to="/addattribute" className="">
                ...
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    ...
                    <li className="sub-menu-item">
                      <Link to="/ordertracking" className="">
                ...
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    <li className="sub-menu-item">
                      <Link to="/alluser" className="">
                        <div className="text">All user</div>
                      </Link>
                    </li>
                    <li className="sub-menu-item">
                      <Link to="/addnewuser" className="">
                ...
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    ...
                    <li className="sub-menu-item">
                      <Link to="/storesettings" className="">
                ...
                <li className="menu-item">
                  <a onClick={handleLogout} className="" style={{ cursor: 'pointer' }}>
                    <div className="icon">
                      <svg
                        width="24"
                        height="22"
